...
export function configure(app, passport, musicoinApi: MusicoinAPI, mediaProvider, config: any) {
  ...
  app.get('/nav/artist/:address', functions.isLoggedInOrIsPublic, (req, res) => {
  ...
  app.get('/nav/*', functions.isLoggedInOrIsPublic, (req, res) => {
  ...
  app.post('/user/canPlay', functions.populateAnonymousUser, function (req, res) {
  ...
  app.get('/ppp/:address', functions.populateAnonymousUser, sendSeekable, resolveExpiringLink, function (req, res) {
    getPlaybackEligibility(req)
