...
export function configure(app, passport, musicoinApi: MusicoinAPI, mediaProvider, config: any) {
    ...
    // =====================================
    app.get('/artist/:address', functions.functions.isLoggedInOrIsPublic, function (req, res) {
    ...
    app.get('/track/:address', functions.functions.isLoggedInOrIsPublic, function (req, res) {
    ...
    app.get('/invite-history', functions.isLoggedIn, (req, res) => {
    ...
    // we will use app middleware to verify this (the functions.isLoggedIn function)

    app.get('/profile', functions.isLoggedIn, function (req, res) {
    ...
    app.post('/send', functions.isLoggedIn, function (req, res) {
    ...
    app.post('/profile/save', functions.isLoggedIn, function (req, res) {
    ...
    app.post('/license/distributeBalance', functions.isLoggedIn, functions.hasProfile, function (req, res) {
    ...
    app.post('/license/delete', functions.isLoggedIn, functions.hasProfile, function (req, res) {
