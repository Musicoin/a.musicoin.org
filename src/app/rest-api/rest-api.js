...
const json_promise_router_1 = require("./json-promise-router");
const FormUtils = require("../form-utils");
const APIClient = require('../../app/models/api-client');
const url = require('url');
const router = express.Router();
const jsonRouter = new json_promise_router_1.JsonPromiseRouter(router, "rest-api");
...
class MusicoinRestAPI {
    constructor(jsonAPI) {
        ...
        jsonRouter.get('/tracks/search', (req) => {
            return jsonAPI.getNewReleasesByGenre(this._getLimit(req), defaultMaxGroupSize, req.query.search);
        });
...
exports.MusicoinRestAPI = MusicoinRestAPI;
