...
function configure(passport, mediaProvider, configAuth) {
    ...
    passport.use(new GoogleStrategy({
        ...
        process.nextTick(function () {
            ...
            doStandardLogin("google", req, localProfile, done);
        });
    }));
    // =========================================================================
    // FACEBOOK ==================================================================
    ...
    passport.use(new FacebookStrategy({
        ...
        process.nextTick(function () {
            ...
            doStandardLogin("facebook", req, localProfile, done);
        });
    }));
    // =========================================================================
    // TWITTER =================================================================
    ...
    passport.use(new TwitterStrategy({
        ...
        process.nextTick(function () {
            ...
            doStandardLogin("twitter", req, localProfile, done);
        });
    }));
    // =========================================================================
    // SOUNDCLOUD =================================================================
    ...
    passport.use(new SoundCloudStrategy({
        ...
        process.nextTick(function () {
            ...
            doStandardLogin("soundcloud", req, localProfile, done);
        });
    }));
    function createUserWithReusableInvite(req) {
        ...
        return User.findOne({
            ...
            return bluebird_1.Promise.join(inviter.save(), newUser.save(), (_inviter, _newUser) => {
                return _newUser;
            })
                .catch(err => {
