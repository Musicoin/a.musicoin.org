...
// =====================================
router.get('/artist/:address', functions.functions.isLoggedInOrIsPublic, function (req, res) {
    ...
    Promise.join(a, m, h, r, x, (output, messages, hero, statsReport, exchangeRate) => {
        ...
        return functions.doRender(req, res, "artist.ejs", output);
    })
});

router.get('/track/:address', functions.functions.isLoggedInOrIsPublic, function (req, res) {
    ...
    Promise.join(l, ms, r, x, votesPromise, (license, messages, release, exchangeRate, votes) => {
        ...
        Promise.join(a, ras, (response, resolvedAddresses) => {
            ...
            return functions.doRender(req, res, "track.ejs", {
...
router.get('/invite-history', functions.isLoggedIn, (req, res) => {
    ...
    jsonAPI.getInvitedBy(req.user._id, start, length)
        .then(invites => {
            ...
            return functions.doRender(req, res, 'invite-history.ejs', {
                invites: output,
                navigation: {
...
router.get('/profile', functions.isLoggedIn, function (req, res) {
    ...
    Promise.join(a, r, (output, exchangeRate) => {
        ...
        output.artist.formattedUSD = exchangeRate.success
            ...
            : "";
        return functions.doRender(req, res, "profile.ejs", output);
    })
});
        ...
        .then(function (license) {
            ...
            return Promise.join(
                ...
                function (contributors) {
                    ...
                    return functions.doRender(req, res, 'license.ejs', { showRelease: false, license: license, hideButtonBar: hideButtonBar });
                });
        })
});
